      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            ...
            variant={"outline"}
            className={cn(
              "w-[300px] min-w-[430px] justify-start text-left font-normal",
          ...
          >
            ...
            {date?.from ? (
              date.to ? (
                <>
                  {`${date.from.getFullYear()}/${String(date.from.getMonth() + 1).padStart(2, "0")}/${String(date.from.getDate()).padStart(2, "0")}`}{" "}
                  -{" "}
